...
declare class ProgramManager {
     ...
     */
    buildExecutionTransaction(programName: string, functionName: string, fee: number, privateFee: boolean, inputs: string[], recordSearchParams?: RecordSearchParams, keySearchParams?: KeySearchParams, feeRecord?: string | RecordPlaintext, provingKey?: ProvingKey, verifyingKey?: VerifyingKey, privateKey?: PrivateKey, offlineQuery?: OfflineQuery, program?: string | Program, imports?: ProgramImports): Promise<Transaction | Error>;
    /**
     ...
     * const transaction = await programManager.networkClient.getTransaction(tx_id);
     */
    execute(programName: string, functionName: string, fee: number, privateFee: boolean, inputs: string[], recordSearchParams?: RecordSearchParams, keySearchParams?: KeySearchParams, feeRecord?: string | RecordPlaintext, provingKey?: ProvingKey, verifyingKey?: VerifyingKey, privateKey?: PrivateKey, offlineQuery?: OfflineQuery, program?: string | Program): Promise<string | Error>;
    /**
     ...
     */
    buildBondPublicTransaction(address: string, amount: number, options?: Options): Promise<Error | Transaction>;
    /**
     ...
     * @param {Options} options Options for the execution
     */
    bondPublic(address: string, amount: number, options?: Options): Promise<string | Error>;
    /**
     ...
     * @param {Options} options Options for the execution
     */
    buildUnbondPublicTransaction(amount: number, options?: Options): Promise<Transaction | Error>;
    /**
     ...
     * @param {Options} options Options for the execution
     */
    unbondPublic(amount: number, options?: Options): Promise<string | Error>;
    /**
     ...
     */
    buildClaimUnbondPublicTransaction(options?: Options): Promise<Transaction | Error>;
    /**
     ...
     * @param {Options} options
     */
    claimUnbondPublic(options?: Options): Promise<string | Error>;
    /**
     * Set Validator State
     * @returns string
     ...
     * @param options
     */
    setValidatorState(validator_state: boolean, options?: Options): Promise<string | Error>;
    /**
     ...
     * @param options
     */
    unbondDelegatorAsValidator(address: string, options?: Options): Promise<string | Error>;
    /**
